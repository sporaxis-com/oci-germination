...
EXPECTED_PGRDF_VERSION="${PGRDF_EXPECTED_VERSION:-0.5.41}"
EXPECTED_PGCK_VERSION="${PGCK_EXPECTED_VERSION:-0.3.4}"
EXPECTED_PGCK_NATIVE_VERSION="${PGCK_EXPECTED_NATIVE_VERSION:-pgck 0.3.4 (rc3)}"
