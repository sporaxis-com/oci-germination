...
OCIGER_RECON_SHA256="$(_ver_val recon_sha256)"
# v3.12 FINAL tree (pgck 0.4.82+). No lexicon module in v3.12.
OCIGER_V312_CORE_SHA256="$(_ver_val v312_core_sha256)"
OCIGER_V312_WAVE_SHA256="$(_ver_val v312_wave_sha256)"
OCIGER_V312_RECON_SHA256="$(_ver_val v312_recon_sha256)"
export OCIGER_PGRDF_VERSION OCIGER_PGCK_VERSION OCIGER_PGCK_NATIVE OCIGER_CKLIB_VERSION OCIGER_NATS_VERSION \
  OCIGER_WAVE_SHA256 OCIGER_LEXICON_SHA256 OCIGER_CORE_SHA256 OCIGER_RECON_SHA256 \
  OCIGER_V312_CORE_SHA256 OCIGER_V312_WAVE_SHA256 OCIGER_V312_RECON_SHA256
